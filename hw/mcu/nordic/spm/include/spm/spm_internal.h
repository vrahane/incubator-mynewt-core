...
/* Total RAM Size for NRF9160 */
#define TOTAL_RAM_SIZE (256*1024)
/* Total FLASH Size for NRF9160 */
#define TOTAL_FLASH_SIZE (1024*1024)

/* SPU RAM regions */
#define RAM_SECURE_ATTRIBUTION_REGION_SIZE 8192 /* XXX For now lets keep it 4k */
#define NUM_RAM_SECURE_ATTRIBUTION_REGIONS (TOTAL_RAM_SIZE \
				/ RAM_SECURE_ATTRIBUTION_REGION_SIZE)

#define FLASH_SECURE_ATTRIBUTION_REGION_SIZE 32768
#define NUM_FLASH_SECURE_ATTRIBUTION_REGIONS (TOTAL_FLASH_SIZE \
