...
#endif
#include "nrfx.h"
#if MYNEWT_VAL(UART_0) || MYNEWT_VAL(UART_1) || MYNEWT_VAL(UART_3) || MYNEWT_VAL(UART_4)
#include "uart/uart.h"
...
#else
static const struct nrf91_hal_i2c_cfg hal_i2c3_cfg = {
...
#else
static const struct nrf91_hal_spi_cfg os_bsp_spi0m_cfg = {
...
static const struct nrf91_hal_spi_cfg os_bsp_spi0s_cfg = {
...
#else
static const struct nrf91_hal_spi_cfg os_bsp_spi1m_cfg = {
...
static const struct nrf91_hal_spi_cfg os_bsp_spi1s_cfg = {
...
#else
static const struct nrf91_hal_spi_cfg os_bsp_spi2m_cfg = {
...
static const struct nrf91_hal_spi_cfg os_bsp_spi2s_cfg = {
...
#else
static const struct nrf91_hal_spi_cfg os_bsp_spi3m_cfg = {
...
static const struct nrf91_hal_spi_cfg os_bsp_spi3s_cfg = {
...
static void
nrf91_periph_create_timers(void)
{
    int rc;
...
void
nrf91_periph_create(void)
{
    nrf91_periph_create_timers();
    nrf91_periph_create_uart();
    nrf91_periph_create_i2c();
    nrf91_periph_create_spi();
}
