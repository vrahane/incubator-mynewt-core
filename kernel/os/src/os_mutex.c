...
os_mutex_init(struct os_mutex *mu)
{
    ...
    os_trace_api_ret_u32(OS_TRACE_ID_MUTEX_INIT, (uintptr_t)ret);
    return ret;
}
...
os_mutex_release(struct os_mutex *mu)
{
    ...
    os_trace_api_ret_u32(OS_TRACE_ID_MUTEX_RELEASE, (uintptr_t)ret);
    return ret;
}
...
os_mutex_pend(struct os_mutex *mu, os_time_t timeout)
{
    ...
    os_trace_api_u32x2(OS_TRACE_ID_MUTEX_PEND, (uintptr_t)mu, (uintptr_t)timeout);
    ...
    os_trace_api_ret_u32(OS_TRACE_ID_MUTEX_PEND, (uintptr_t)ret);
    return ret;
}
