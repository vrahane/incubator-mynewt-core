...
{
    os_trace_api_u32x2(OS_TRACE_ID_CALLOUT_INIT, (uint64_t)c, (uint64_t)evq);
...
os_callout_stop(struct os_callout *c)
{
    ...
    os_trace_api_u32(OS_TRACE_ID_CALLOUT_STOP, (uint64_t)c);
...
os_callout_reset(struct os_callout *c, os_time_t ticks)
{
    ...
    os_trace_api_u32x2(OS_TRACE_ID_CALLOUT_RESET, (uint64_t)c, (uint64_t)ticks);
...
err:
    os_trace_api_ret_u32(OS_TRACE_ID_CALLOUT_RESET, (uint64_t)ret);
    return ret;
}
